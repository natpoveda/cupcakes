 ...
 */
function cake_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
 ...
 */
function cake_process_html(&$vars) {
 ...
 */
function cake_preprocess_page(&$vars) {
 ...
 */
function cake_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function cake_preprocess_block(&$variables) {
 ...
 */
function cake_breadcrumb($variables) {
 ...
 */
function cake_form_alter(&$form, &$form_state, $form_id) {
